...
# follow-up status
#----------------------------------
table1::table1(~ age_enroll + factor(pgp3_pos) + factor(tf) + factor(pcr_individual) + factor(nmeas) + factor(nperiods)  | fup, data = dloss_indiv %>% filter(survey<=36))
```

## Estimate SCR and SRR
